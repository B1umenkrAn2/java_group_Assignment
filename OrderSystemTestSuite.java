...
public class OrderSystemTestSuite {
    ...
    static CustomerPojo newCustomer = new CustomerPojo("Peter", "Pan");
    ...
    @Test
    public void test02_find_all_customers_with_norole() throws JsonMappingException, JsonProcessingException {
        Response response = webTarget
            .path(CUSTOMER_RESOURCE_NAME)
            .request()
            .get();
    ...
    @Test
    public void test03_find_customer_by_id_norole() throws JsonMappingException, JsonProcessingException {
        Response response = webTarget
    ...
    @Test
    public void test04_find_customer_by_id_adminrole() throws JsonMappingException, JsonProcessingException {
        Response response = webTarget
            .register(adminAuth)
            .path(CUSTOMER_RESOURCE_NAME + RESOURCE_PATH_ID_PATH)
        ...
        assertThat(c1.getFirstName(), is(equalToIgnoringCase("Mike")));
        assertThat(c1.getLastName(), is(equalToIgnoringCase("Norman")));
    }
    ...
    public void test07_find_customer2_by_id_adminrole() throws JsonMappingException, JsonProcessingException {
        ...
        assertThat(response.getStatus(), is(OK.getStatusCode()));
        CustomerPojo c1 = response.readEntity(new GenericType<CustomerPojo>(){});
        assertThat(c1.getFirstName(), is(equalToIgnoringCase("Brad")));
        assertThat(c1.getLastName(), is(equalToIgnoringCase("Pitt")));
    }
    ...
    @Test
    public void test12_update_customer1_with_userrole() {
    ...
    @Test
    public void test14_remove_customer3_by_id_norole() throws JsonMappingException, JsonProcessingException {
        Response response = webTarget
            .path(CUSTOMER_RESOURCE_NAME + RESOURCE_PATH_ID_PATH)
            .resolveTemplate(RESOURCE_PATH_ID_ELEMENT, 3)
            .request()
    ...
    @Test
    public void test15_remove_customer3_by_id_userrole() throws JsonMappingException, JsonProcessingException {
        Response response = webTarget
            .register(userAuth)
            .path(CUSTOMER_RESOURCE_NAME + RESOURCE_PATH_ID_PATH)
            .resolveTemplate(RESOURCE_PATH_ID_ELEMENT, 3)
    ...
    @Test
    public void test16_remove_employee_with_adminrole() throws JsonMappingException, JsonProcessingException {
        Response response = webTarget
            .register(adminAuth)
            .path(CUSTOMER_RESOURCE_NAME + RESOURCE_PATH_ID_PATH)
            .resolveTemplate(RESOURCE_PATH_ID_ELEMENT, 3)
