...
public interface MyConstants {
    ...
    public static final String ONE_CUST_ALL_ADDRESS = RESOURCE_PATH_ID_PATH + SLASH + CUSTOMER_ADDRESS_SUBRESOURCE_NAME;
    public static final String ONE_CUST_ONE_ADDRESS = RESOURCE_PATH_ID_PATH + SLASH + CUSTOMER_ADDRESS_SUBRESOURCE_NAME + RESOURCE_PATH_ID_PATH;
    ...
    public static final String ONE_ORDER_ALL_ORDERLINE =  ORDER_RESOURCE_NAME +RESOURCE_PATH_ID_PATH+ SLASH + ORDER_RESOURCE_SUBRESOURCE_NAME  ;
    public static final String ONE_ORDER_ONE_ORDERLINE =  ORDER_RESOURCE_NAME + RESOURCE_PATH_ID_PATH + SLASH + ORDER_RESOURCE_SUBRESOURCE_NAME + RESOURCE_PATH_ID_PATH;
